package com.smnadim21.satouism.adapter;
...
import com.smnadim21.api.Subscription;
...
import static com.smnadim21.api.BdApps.showDialog;
import static com.smnadim21.api.BdApps.subscribe;
import static com.smnadim21.api.Subscription.getSubscriptionStatus;
...
public class TopicsAdapter extends RecyclerView.Adapter<TopicsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Glide.with(context)
                .load(mDataset.get(position).getImageres())
            ...
            public void onClick(View view) {
                ...
                if (Subscription.getSubscriptionStatus())
                {
                    ...
                    context.startActivity(new Intent(context, ItemActivity.class)
                            ...
                            .putExtra("img", mDataset.get(holder.getAdapterPosition()).getImageres())
